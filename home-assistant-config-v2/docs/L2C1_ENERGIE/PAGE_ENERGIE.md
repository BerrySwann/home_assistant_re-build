...
| Champ | Valeur |
|:------|:-------|
| 📁 **Path** | `dashbord/page_energie_home.yaml` |
...
> ⚠️ **Pages liées non documentées ici** : `energie-temps-reel` et `energie-mensuel` sont 2 pages séparées accessibles uniquement depuis les badges. Elles nécessitent leurs propres fichiers de documentation (`PAGE_ENERGIE_TEMPS_REEL.md` et `PAGE_ENERGIE_MENSUEL.md` — à créer).
...
← Retour : `docs/L2C1_ENERGIE/L2C1_VIGNETTE_ENERGIE.md` | → Pages liées : `PAGE_ENERGIE_TEMPS_REEL.md` · `PAGE_ENERGIE_MENSUEL.md` *(à créer)* | → Suivant : `docs/L2C2_*/` *(à venir)*
