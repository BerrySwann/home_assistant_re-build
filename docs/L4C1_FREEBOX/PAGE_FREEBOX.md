...
| 🔗 **Accès depuis** | Vignette L4C1 (tap) |
| 🏗️ **Layout** | `type: grid` — 2 colonnes |
| ⚠️ **Note matérielle** | Page originellement optimisée pour **Raspberry Pi** — peut nécessiter des ajustements sur x86-64 (entités Freebox différentes selon l'architecture) |
...
# 🌐 L4C1 — Page Freebox Pop + Pop-up Speedtest
