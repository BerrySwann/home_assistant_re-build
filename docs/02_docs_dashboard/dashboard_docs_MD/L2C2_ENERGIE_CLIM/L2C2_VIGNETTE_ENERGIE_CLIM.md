...
| 6 | `sensor.salon_power_status` | TPL | ON/OFF Salon | `P1_clim_chauffage/P1_ui_dashboard/P1_ui_dashboard.yaml` |
...
| `templates/P1_clim_chauffage/P1_ui_dashboard/P1_ui_dashboard.yaml` | Templates power_status + etat |
