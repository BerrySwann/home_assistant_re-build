...
│
├── [HEADING] Salle de Bain   [badges: T°, light.hue_white_lamp_salle_de_bain, switch.relais_lumiere_sdb_sonoff]
...
| `light.hue_white_lamp_salle_de_bain` | Philips Hue Bridge | Lampe SdB |
