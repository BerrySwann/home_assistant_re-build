...
Le YAML complet de la vignette est volumineux (18 champs JS). Seuls les éléments structurants sont reproduits ici ; le code intégral est dans `Dashboard/L6C1_16_Air_Qualite/vignette_L6C1_air_qualite_2026-05-14.yaml`.
