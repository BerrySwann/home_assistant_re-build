...
| `sensor.{slug}_{cycle}_um_kwh_tpl` | `templates/P3_eclairage/P3_ENERGIE_TPL/P3_TPL_AMHQ_1_UNITE.yaml` | ✅ Relais |
| `sensor.eclairage_{zone}_{cycle}_um_kwh_tpl` | `templates/P3_eclairage/P3_ENERGIE_TPL/P3_TPL_AMHQ_2_ZONE.yaml` | ✅ Essentiel |
| `sensor.eclairage_total_unit_{cycle}_kwh_tpl` | `templates/P3_eclairage/P3_ENERGIE_TPL/P3_TPL_AMHQ_3_TOTAL.yaml` | ✅ Essentiel |
