...
| Appareil       | Entité (`_quotidien_um`)                                  | Couleur              |
|----------------|---------------------------------------------------------------|----------------------|
| Box Internet   | `sensor.prise_box_internet_ikea_quotidien_um`             | `gainsboro`          |
| Horloge        | `sensor.prise_horloge_ikea_quotidien_um`                  | `rgb(183, 183, 183)` |
...
| Appareil       | Entité (`_quotidien_um`)                                  | Couleur                  |
|----------------|---------------------------------------------------------------|--------------------------|
| PC Géraldine   | `sensor.prise_pc_s_gege_ikea_quotidien_um`                | `rgb(174, 68, 90)`       |
| Chargeur Salon | `sensor.prise_salon_chargeur_nous_quotidien_um`           | `rgb(196, 75, 97)`       |
| TV Salon       | `sensor.prise_tv_salon_ikea_quotidien_um`                 | `rgb(215, 95, 115)`      |
...
| Appareil         | Entité (`_quotidien_um`)                                  | Couleur                |
|------------------|---------------------------------------------------------------|------------------------|
| Four Micro-ondes | `sensor.prise_four_micro_ondes_nous_quotidien_um`         | `rgb(98, 78, 136)`     |
| Petit-déjeuner   | `sensor.prise_petit_dejeune_nous_quotidien_um`            | `rgb(118, 93, 160)`    |
| Lave-linge       | `sensor.prise_lave_linge_nous_quotidien_um`               | `rgb(137, 103, 179)`   |
| Lave-vaisselle   | `sensor.prise_lave_vaisselle_nous_quotidien_um`           | `rgb(129, 116, 180)`   |
| AirFryer Ninja   | `sensor.prise_airfryer_ninja_nous_quotidien_um`           | `rgb(142, 122, 181)`   |
| Four & Plaque    | `sensor.four_et_plaque_de_cuisson_quotidien_um`           | `rgb(162, 148, 249)`   |

### Froid (2 appareils)

| Appareil   | Entité (`_quotidien_um`)                                  | Couleur              |
|------------|---------------------------------------------------------------|----------------------|
| Frigo      | `sensor.prise_frigo_cuisine_nous_quotidien_um`            | `cyan`               |
| Congélateur| `sensor.prise_congelateur_cuisine_nous_quotidien_um`      | `rgb(19, 160, 255)`  |
...
| Appareil       | Entité (`_quotidien_um`)                                  | Couleur                  |
|----------------|---------------------------------------------------------------|--------------------------|
| PC Bureau      | `sensor.prise_bureau_pc_ikea_quotidien_um`                | `rgb(255, 165, 0)`       |
| Fer à repasser | `sensor.prise_bureau_fer_a_repasser_nous_quotidien_um`    | `rgb(255, 183, 51)`      |
...
| Appareil    | Entité (`_quotidien_um`)                                  | Couleur                  |
|-------------|---------------------------------------------------------------|--------------------------|
| Tête de lit | `sensor.prise_tete_de_lit_chambre_quotidien_um`           | `rgb(75, 130, 85)`       |
| TV Chambre  | `sensor.prise_tv_chambre_nous_quotidien_um`               | `rgb(105, 155, 110)`     |
...
|-------------|---------------------------------------------------------------|---------|
| All Standby | `sensor.all_standby_quotidien_um`                         | `grey`  |
...
Pattern général : `sensor.prise_{slug}_{marque}_{periode}_um`
