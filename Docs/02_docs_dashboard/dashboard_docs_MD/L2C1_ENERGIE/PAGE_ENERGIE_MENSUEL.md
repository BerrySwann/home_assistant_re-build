...
| Champ | Valeur |
|:------|:-------|
| 📁 **Path** | `Dashboard/L2C1_04_Energie_Generale/page_L2C1_energie_mensuel_2026-06-18.yaml` |
...
| Rôle | Chemin |
|------|--------|
| Page mensuelle (YAML) | `Dashboard/L2C1_04_Energie_Generale/page_L2C1_energie_mensuel_2026-06-18.yaml` |
| Page principale énergie | `Dashboard/L2C1_04_Energie_Generale/page_L2C1_energie_principale_2026-06-18.yaml` |
| Page temps réel | `Dashboard/L2C1_04_Energie_Generale/page_L2C1_energie_temps_reel_2026-06-18.yaml` |
