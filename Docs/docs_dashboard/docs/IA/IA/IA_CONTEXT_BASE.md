...
- ⚠️ Supprimé — `sensor.proxmox_cpu_package`, `proxmox_carte_mere`, `proxmox_core_0/1/2/3` utilisés directement (MQTT natif)
...
| Relais kWh | `{slug}_{cycle}_um_kwh_tpl` | `P3_ENERGIE_TPL` | `hue_white_lamp_table_quotidien_um_kwh_tpl` |
...
| `meteo_france` | Alertes vigilance, prévisions, cameras cartes (Core HA) |
...
## 🌳 ARBORESCENCE — STRUCTURE HA EN PRODUCTION (/homeassistant/)

```text
/homeassistant/                                         (racine — fichiers de configuration globaux)
...
├── #sensors.yaml                                (désactivé — remplacé par /homeassistant/sensors/)
├── #templates.yaml                              (désactivé — remplacé par /homeassistant/templates/)
└── #utility_meter.yaml                          (désactivé — remplacé par /homeassistant/utility_meter/)
...
│   └── P2_éCO_prises
│       └── P2_eco_prises_config.yaml            (liste config prises eco — sensor.eco_prises_config)
├── P3_eclairage
│   ├── P3_ENERGIE_TPL                           (relais _um → _um_kwh_tpl + zones + total)
...
│   (⚠️ P0_Genelec_appart/P0_kWh_genelec_appart.yaml supprimé — Riemann retiré 2026-06-02)
├── P1_clim_chauffage
│   └── P1_DUT
│       └── P1_DUT_clim_chauffage.yaml           (history_stats DUT × 6 équipements P1)
│   (⚠️ P1_kWh/ supprimé — P1_kWh_clim_chauffage.yaml retiré)
│   (⚠️ P2_prise/ supprimé — P2_kWh_prises/veilles/Wh_mini_pc retirés)
│   (⚠️ P3_eclairage/ supprimé — remplacé par P3_ENERGIE_TPL layer)
└── meteo
...
**Pôle 3 - Éclairage & UI**
- https://raw.githubusercontent.com/BerrySwann/home_assistant_re-build/main/templates/P3_eclairage/P3_ENERGIE_TPL/P3_TPL_AMHQ_1_UNITE.yaml
- https://raw.githubusercontent.com/BerrySwann/home_assistant_re-build/main/templates/P3_eclairage/P3_ENERGIE_TPL/P3_TPL_AMHQ_2_ZONE.yaml
- https://raw.githubusercontent.com/BerrySwann/home_assistant_re-build/main/templates/P3_eclairage/P3_ENERGIE_TPL/P3_TPL_AMHQ_3_TOTAL.yaml
...
**Pôle 3 - Éclairage**
*(P2_prise/ supprimé — P3_eclairage/ supprimé — remplacés par TPL layer `P3_ENERGIE_TPL/`)*
