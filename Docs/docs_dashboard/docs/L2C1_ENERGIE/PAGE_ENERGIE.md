...
| Champ | Valeur |
|:------|:-------|
| 📁 **Path** | `Dashboard/L2C1_04_Energie_Generale/page_L2C1_energie_principale_2026-06-18.yaml` |
...
> Sources UM total : `utility_meter/P0_Energie_total/Genelec_appart/01_UM_AMHQ.yaml`
> Sources UM HP/HC : `utility_meter/P0_Energie_total/Genelec_appart/02_UM_genelec_appart_HPHC_AMHQ.yaml`
...
> Source UM total : `utility_meter/P0_Energie_total/Genelec_appart/01_UM_AMHQ.yaml`
> Source UM HP/HC : `utility_meter/P0_Energie_total/Genelec_appart/02_UM_genelec_appart_HPHC_AMHQ.yaml`
...
| Entité | Rôle | Source |
|--------|------|--------|
| `sensor.genelec_appart_totale_kwh` | kWh local stable (Riemann left) — source des UM | `sensors/P0_Energie_total_min_maxi_diag/P0_Genelec_appart/P0_kWh_genelec_appart.yaml` |
...
| Entité | Rôle | Source |
|--------|------|--------|
| `sensor.genelec_appart_conso_mini_24h` | `value_min` 24h UM quotidien — toujours 0 (reset minuit) | `sensors/P0_Energie_total_min_maxi_diag/P0_Genelec_appart_mini_maxi/P0_MINI_MAXI_AVG_Genelec_appart.yaml` |
...
|--------|-------|-------|--------|
| `sensor.genelec_appart_hphc_quotidien_um_hp` | daily | HP | `utility_meter/P0_Energie_total/Genelec_appart/02_UM_genelec_appart_HPHC_AMHQ.yaml` |
...
2. Vérifier les UM HP/HC dans `02_UM_genelec_appart_HPHC_AMHQ.yaml`
...
| Rôle | Chemin |
|------|--------|
| Dashboard YAML corrigé | `Dashboard/L2C1_04_Energie_Generale/page_L2C1_energie_principale_2026-06-18.yaml` |
| Riemann tampon NODON | `TREE_CORRIGE/sensors/P0_Energie_total_min_maxi_diag/P0_Genelec_appart/P0_kWh_genelec_appart.yaml` |
| UM kWh total AMHQ | `TREE_CORRIGE/utility_meter/P0_Energie_total/Genelec_appart/01_UM_AMHQ.yaml` |
| UM HP/HC AMHQ | `TREE_CORRIGE/utility_meter/P0_Energie_total/Genelec_appart/02_UM_genelec_appart_HPHC_AMHQ.yaml` |
| Statistiques mini/maxi/moy | `TREE_CORRIGE/sensors/P0_Energie_total_min_maxi_diag/P0_Genelec_appart_mini_maxi/P0_MINI_MAXI_AVG_Genelec_appart.yaml` |
